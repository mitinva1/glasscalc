...
#создать переменнуюв ширины и высоты пока -
#doormiddlex=760
doormiddley = 285 #середина двери по высоте
doorhandleheight = 600 # высота офисной ручки
doorhandlehewidth = 32 # диаметр офисной ручки
...
class ExampleApp(QMainWindow, door2.Ui_GlassCalc, scene.myyScene):
    def __init__(self):
        ...
        self.comboBox_11.addItems(['без']+connectbs('DoorHandle'))
        self.comboBox_11.activated[str].connect(self.onActivated11)
        self.comboBox_12.addItems(['без']+connectbs('PushHandle'))
        self.comboBox_12.activated[str].connect(self.onActivated12)
        ...
        self.comboBox_23.addItems(['без']+connectbs('DoorHandle'))
        self.comboBox_23.activated[str].connect(self.onActivated11_2)
        self.comboBox_24.addItems(['без']+connectbs('PushHandle'))
        self.comboBox_24.activated[str].connect(self.onActivated12_2)
...
#активаторы выпадающего списка
    ...
    def onActivated12(self, text):#активация нижниго фитинга
        global PushHandle
    ...
    def onActivated12_2(self, text):#активация нижниго фитинга
        global PushHandle2
        xxx = doorclass.PushHandle
        if text == 'без':
            PushHandle2 = doorclass.PushHandle('None')
...
#filling class newDoor
        ...
        self.label_23.setText(str(newDoor.doorPrice()*discount  + (door_installation_price*newDoor.area) + inst_door_closer*newDoor.quantitydoor))#цена двери на скидку + установка на площадь + уст. даводчиков на двери
#save image and exel file
    def screenshot(self):
        ...
        ws['I39'] = newDoor.doorPrice()*discount + door_installation_price*newDoor.area + inst_door_closer*newDoor.quantitydoor
